...
const NAV = [
  ...
  { href:"/consumables", label:"Consommables", icon:<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 7h16v13H4zM7 7V4h10v3M8 12h8M8 16h5"/></svg> },
