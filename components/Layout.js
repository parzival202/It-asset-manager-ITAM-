...
export default function Layout({ children, title, actions, alertCount = 0 }) {
  ...
  // Pendant le SSR ou avant le montage, rendu minimal
  if (!mounted || !auth) {
    return (
    ...
    <div className="layout">
      <aside className="sidebar">
        ...
        <div className="sidebar-user">
          ...
          <button onClick={logout} title="Déconnexion" style={{background:"none",border:"none",color:"var(--text3)",cursor:"pointer",padding:"4px",display:"flex",alignItems:"center"}}>
